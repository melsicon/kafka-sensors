...
import de.melsicon.kafka.sensors.serialization.reflect.SensorState.State;
...
public final class SerializationTest {
  ...
  public static void before() {
    encoder =
        new BinaryMessageEncoder<>(SensorStateWithDuration.MODEL, SensorStateWithDuration.SCHEMA);
    decoder =
        new BinaryMessageDecoder<>(SensorStateWithDuration.MODEL, SensorStateWithDuration.SCHEMA);
  }
